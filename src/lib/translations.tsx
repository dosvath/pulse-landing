...
export const TRANSLATIONS: Record<PlatformLanguage, TranslationTree> = {
  ...
  [PlatformLanguage.RUSSIAN]: {
    ...
    INTERNATIONAL_SECTION: {
      ...
      SUBHEADING: (
        <>
          Планируйте знакомства заранее. Ищите совпадения по разных городах и
          национальности сразу —{" "}
          <strong className="text-white">так не умеют другие приложения</strong>
        </>
      ),
    },
    MESSAGES_SECTION: {
